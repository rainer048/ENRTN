         ...
         return value;
          ...
          if(isPrivateSale){
              if(cost>0 && cost<=10*ETH){
                  return value += value.div(100).mul(20);
              }
              if(cost>=11*ETH && cost<=30*ETH){
                   return value += value.div(100).mul(25);
               }
               if(cost>=31*ETH){
                    return value += value.div(100).mul(30);
                }
             }
             else{
                 if(cost>0 && cost<=10*ETH){
                 ...
                 if(cost>=11*ETH && cost<=30*ETH){
                      return value += value.div(100).mul(15);
                  }
                  if(cost>=31*ETH && cost<=50*ETH){
                       return value += value.div(100).mul(20);
                   }
                   if(cost>=51*ETH){
                        return value += value.div(100).mul(25);
